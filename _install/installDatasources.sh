...
# ================== ALWAYS =====================
## Insert Coastlines
shp2pgsql -g geom -d -W LATIN1 -s 4326 -I $COASTLINES datasources.coastlines | psql -d $DB -U $SUPERUSER -h $HOSTNAME
psql -d $DB -U $SUPERUSER -h $HOSTNAME << EOF
...
## Insert Continents
shp2pgsql -g geom -d -W LATIN1 -s 4326 -I $CONTINENTS datasources.continents | psql -d $DB -U $SUPERUSER -h $HOSTNAME

## Insert Countries
shp2pgsql -g geom -d -W LATIN1 -s 4326 -I $COUNTRIES datasources.countries | psql -d $DB -U $SUPERUSER -h $HOSTNAME
psql -d $DB -U $SUPERUSER -h $HOSTNAME << EOF
...
shp2pgsql -g geom -d -W UTF8 -s 4326 -I $STATES datasources.states | psql -d $DB -U $SUPERUSER -h $HOSTNAME
psql -d $DB -U $SUPERUSER -h $HOSTNAME << EOF
...
# =================== GEOLOGY ==================
## Insert plates
shp2pgsql -g geom -d -W UTF8 -s 4326 -I $PLATES datasources.plates | psql -d $DB -U $SUPERUSER -h $HOSTNAME

## Insert faults
shp2pgsql -g geom -d -W UTF8 -s 4326 -I $FAULTS datasources.faults | psql -d $DB -U $SUPERUSER -h $HOSTNAME
psql -d $DB -U $SUPERUSER -h $HOSTNAME << EOF
...
## Insert volcanoes
shp2pgsql -g geom -d -W UTF8 -s 4326 -I $VOLCANOES datasources.volcanoes | psql -d $DB -U $SUPERUSER -h $HOSTNAME

## Insert glaciers
shp2pgsql -g geom -d -W LATIN1 -s 4326 -I $GLACIERS datasources.glaciers | psql -d $DB -U $SUPERUSER -h $HOSTNAME

# =================== HYDROLOGY ==================
## Insert Rivers
shp2pgsql -g geom -d -W LATIN1 -s 4326 -I $RIVERS datasources.rivers | psql -d $DB -U $SUPERUSER -h $HOSTNAME

# =================== OTHER ==================
## Insert Physicals data
shp2pgsql -g geom -d -W LATIN1 -s 4326 -I $MARINEAREAS datasources.physical | psql -d $DB -U $SUPERUSER -h $HOSTNAME
psql -d $DB -U $SUPERUSER -h $HOSTNAME << EOF
